...
// std::enable_if_t and std::remove_reference_t are provided by <type_traits>
// (already included above). Injecting them into namespace std violates the
// C++ standard (ODR / UB risk) and is unnecessary on C++14+ compilers.
