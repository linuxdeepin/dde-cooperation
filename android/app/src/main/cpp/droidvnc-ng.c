...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void __unused * reserved) {
    ...
    */
    ...
    theInputService = (*env)->NewGlobalRef(env, (*env)->FindClass(env, "com/deepin/assistant/services/InputService"));
    theMainService = (*env)->NewGlobalRef(env, (*env)->FindClass(env, "com/deepin/assistant/services/MainService"));
...
JNIEXPORT jboolean JNICALL Java_com_deepin_assistant_services_MainService_vncStopServer(__unused JNIEnv *env, __unused jobject thiz) {
...
JNIEXPORT jboolean JNICALL Java_com_deepin_assistant_services_MainService_vncStartServer(JNIEnv *env, jobject thiz, jint width, jint height, jint port, jstring desktopname, jstring password, jstring httpRootDir) {
    ...
    if(!theScreen->frameBuffer) {
        ...
        Java_com_deepin_assistant_services_MainService_vncStopServer(env, thiz);
        return JNI_FALSE;
    }
...
JNIEXPORT jlong JNICALL Java_com_deepin_assistant_services_MainService_vncConnectReverse(JNIEnv *env, __unused jobject thiz, jstring host, jint port)
{
...
// The MainService run this on a worker thread, in the worst case blocking for rfbMaxClientWait
JNIEXPORT jlong JNICALL Java_com_deepin_assistant_services_MainService_vncConnectRepeater(JNIEnv *env, __unused jobject thiz, jstring host, jint port, jstring repeaterIdentifier)
{
    if(!theScreen || !theScreen->frameBuffer)
        return 0;
...
JNIEXPORT jboolean JNICALL Java_com_deepin_assistant_services_MainService_vncNewFramebuffer(__unused JNIEnv *env, __unused jobject thiz, jint width, jint height)
{
...
JNIEXPORT jboolean JNICALL Java_com_deepin_assistant_services_MainService_vncUpdateFramebuffer(JNIEnv *env, jobject  __unused thiz, jobject buf)
{
...
JNIEXPORT jint JNICALL Java_com_deepin_assistant_services_MainService_vncGetFramebufferWidth(__unused JNIEnv *env, jobject __unused thiz)
{
    if(!theScreen || !theScreen->frameBuffer)
        return -1;
...
JNIEXPORT jint JNICALL Java_com_deepin_assistant_services_MainService_vncGetFramebufferHeight(__unused JNIEnv *env, jobject __unused thiz)
{
    if(!theScreen || !theScreen->frameBuffer)
        return -1;
...
JNIEXPORT jboolean JNICALL Java_com_deepin_assistant_services_MainService_vncIsActive(JNIEnv *env, jobject thiz) {
