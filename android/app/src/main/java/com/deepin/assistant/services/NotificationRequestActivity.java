...
import static com.hjq.permissions.Permission.POST_NOTIFICATIONS;
       ...
       if (checkSelfPermission(POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
           ...
           if (!prefs.getBoolean(PREFS_KEY_POST_NOTIFICATION_PERMISSION_ASKED_BEFORE, false)) {
               new AlertDialog.Builder(this)
                       ...
                       .setPositiveButton(R.string.yes, (dialog, which) -> requestPermissions(new String[]{POST_NOTIFICATIONS}, REQUEST_POST_NOTIFICATION))
